          ...
          <div class="
            ...
            <form @submit.prevent="authStore.handleRegister(form)">
              <div class="mb-6">
                <input 
                autocomplete="name"
                type="text" name="name" placeholder="Name" v-model="form.name" class="
                    border-[#E9EDF4]
                    w-full
                    rounded-md
                    border
              ...
              <div class="mb-6">
                <input 
                autocomplete="email"
                type="email" name="email" placeholder="Email" v-model="form.email" class="
                    border-[#E9EDF4]
                    w-full
                    rounded-md
                    border
              ...
              <div class="mb-6">
                ...
                type="password" name="password" placeholder="Password" v-model="form.password" class="
                    border-[#E9EDF4]
                    w-full
                    rounded-md
                    border
              ...
              <div class="mb-6">
                ...
                type="password" name="password_confirmation" placeholder="Password Confirmation"
                  v-model="form.password_confirmation" class="
                    border-[#E9EDF4]
                    w-full
                    rounded-md
                    border
